...
public class AlquilerCanchaDAO extends BaseDAO {
    ...
    public void insertar(AlquilerCancha vo) throws DAOExcepcion {
    ...
    public AlquilerCancha obtener(int idHorario) throws DAOExcepcion {
...
//                vo.setTarifaNocturna(rs.getDouble(4));
    ...
    //Francisco
    public Collection<AlquilerCancha> listar(Integer idCliente) throws DAOExcepcion {
