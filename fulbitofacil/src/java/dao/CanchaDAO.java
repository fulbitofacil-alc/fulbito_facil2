...
public class CanchaDAO extends BaseDAO {
    ...
    public void insertar(Cancha vo, List<HorarioCancha> lista) throws DAOExcepcion {
        ...
        try {
            ...
            try {
                ...
                if (i != 1) {
                    throw new DAOExcepcion("Error al insertar cancha");
                }
            ...
            for (HorarioCancha hc : lista) {
                try {
                    ...
                    int i = stmt.executeUpdate();
                    if (i != 1) {
                        throw new DAOExcepcion("Error al insertar horario");
                    }
                } catch (SQLException e) {
                    System.err.println(e.getMessage());
                    throw new DAOExcepcion(e.getMessage());
    ...
    public Cancha obtener(String nombre, Integer idLocal) throws DAOExcepcion {
    ...
    public List<HorarioCancha> listar(Integer idCancha, Integer distrito, String dia, String hora) throws DAOExcepcion {
        System.out.println("CanchaDAO: obtener(String nombre)");
